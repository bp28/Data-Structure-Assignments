 ...
 * @param xsize Length of one direction of the array
 * @param ysize Length of the other direction of the array
 ...
 * @details Prints out info on the created 'world'
 */
 ...
 * @details This can be loaded into Excel or similar
 */
 ...
 * @param city1 First city input
 * @param city2 Second city input
 */
...
* @details The first city is the original start point as well as the end point.  The number of
* cities passed in does not include this start/end point (so there will be length+1 entries in 
* the returned vector).
